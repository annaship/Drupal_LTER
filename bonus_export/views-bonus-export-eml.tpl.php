...
} // function print_temporal_coverage
...
} // function print_geographic_coverage
                  ...
                  foreach ($value1 as $value2) {
                   ...
                   if ($attribute_formatstring || $attribute_maximum || $attribute_minimum ||
                      ...
                      // example???
                                ...
                                // )
                                // </pre>
                                # warning: preg_match() expects parameter 2 to be string, array given in /var/www/prototype/sites/all/modules/views_bonus_eml_eml/export/views-bonus-eml-export-eml.tpl.php on line 556.
                    ...
                    } // endif; if ($attribute_formatstring || $attribute_maximum || $attribute_minimum ||
                     //$attribute_precision || $attribute_unit)
