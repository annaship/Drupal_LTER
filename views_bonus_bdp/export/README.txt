Bonus: Views Export BDP
--------------------------------------------------------------------------------
This modules is based on Bonus: Views Export and adds BDP feed type
that can be used to export data from your views.

Using the "Bonus: Views Export BDP" module.
--------------------------------------------------------------------------------
1. Add a new "Feed" display to your view.
2. Change its "Style" to the "BDP file".
3. Configure the options (such as name, quote, etc.). You can go back and do
   ...
   selected.
4. Give it a path in the Feed settings such as "path/to/view/bdp".
